    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Toast.makeText(MessageActivity.this, "Encrypted Mode On", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(MessageActivity.this, "Encrypted Mode Off", Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")){
                    if(s.isChecked()) {
                        ...
                        sendMessage(fuser.getUid(), userid, encryptedMsg);
                    }
                    else {
...
//                Log.d("Position ", String.valueOf(mchat.get(position)));
//            }
//
//            @Override
...
//        }));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menude, menu);
        return true;
    }
